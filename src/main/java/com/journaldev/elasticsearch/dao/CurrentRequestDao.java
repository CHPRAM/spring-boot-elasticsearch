...
@Repository
public class CurrentRequestDao {

    private final String INDEX = "IPTRACK";
    private final String TYPE = "chp";

    private RestHighLevelClient restHighLevelClient;

    private ObjectMapper objectMapper;

    public CurrentRequestDao( ObjectMapper objectMapper, RestHighLevelClient restHighLevelClient) {
